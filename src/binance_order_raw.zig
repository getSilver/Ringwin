...
pub const RawIngressRecord = struct { source_session: u64, receive_time_utc_ns: u64, monotonic_time_ns: u64, wall_time_utc_ns: u64, byte_len: u32, sha256: [Sha256.digest_length]u8 };
pub const RawEvidenceRef = struct { stream_sequence: u64, sha256: [Sha256.digest_length]u8 };

...
- [从真实磁盘日志与快照恢复一个 TradingShard](issues/03-persist-and-recover-authoritative-state.md)
...
- 当前可信离线基线为 acceptance schema 2、journal/state schema 8、Debug/ReleaseSafe 各 191 项；
